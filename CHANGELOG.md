...
### Changed
- Clarified extension description and documentation from "no permissions" to "no data collected" to avoid confusion with Chrome's standard host permission prompts for content scripts.
